...
> by **tanchunzhuo** ｜ v1.0（2026-08）｜ MIT 协议 ｜ 随《AI时代，什么工作值得做？》附赠
...
本工具随 **《AI时代，什么工作值得做？》——站在 AI 的侧翼，找到你的职业坐标**（作者 tanchunzhuo）附赠。

书讲「为什么」：在 AI 时代，判断一份工作有没有前景，只看一件事——它站在模型进步的**正面、背面，还是侧翼**。工具讲「怎么做」：「侧翼雷达」就是这套心智模型的交互版，你输入自己是谁，它帮你落到具体方向。**书给你地图，工具陪你走。**
